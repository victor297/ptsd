...
def main():
    ...
    if choice == 'Home':
        ...
        <h2 style= "color: #ff0000; font-family: 'Raleway',sans-serif; font-size: 44px; font-weight: 700; line-height: 102px; margin: 0 0 24px; text-align: center; text-transform: uppercase;">How are you feeling today? </h2>
        </marquee><br>
        """
